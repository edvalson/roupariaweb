...
<c:import url="${request.contextPath}/menu" />
 <div class="panel panel-default">
		<div class="panel-heading">
		   <tr>
			<th><h1><strong>Lista de Peças</strong></h1></th>   
			<br />
		    <br />
          </tr>
		    ...
		    <form:form method="get" action="${urlFiltro}" modelAttribute="filtro">
			    ...
			    <strong>Tamanho: </strong><form:input path="tamanho"/> 
		...
		<div class="panel-body">
			<div class="table-responsive">
				...
				<a  class="btn btn-sm btn-primary" href='<c:url value="/peca/${peca.id}/remove" />'>remover</a>
				<a class="delete btn btn-sm btn-danger" href='<c:url value="/peca/${peca.id}/form" />'>editar</a>
				</div>
			</td>
		</tr>
		</c:forEach>
		...
		<div class="panel-footer">
		   <c:url var="url" value="/peca/form" />
		   <a class="btn btn-sm btn-success" href='${url}'>Adicionar Peça</a>
